...
class ESN:
    ...
    def change_reservoir_constants(self, reservoir_size=None, feedback_gain=None, input_gain=None, spatial_multiplexing=None):
        """
    ...
    def NMSE(self, true_outputs, generated_outputs):
        ...
        Parameters
        ----------
        true_outputs : A 2D Numpy array of the true values
        generated_outputs : A 2D Numpy array of the predicted values
        
        Returns
        -------
        A real value of NMSE
