...
def dagger(operator : NDArray[Any]) -> NDArray[Any]:
    """
...
def tensor(operators: list[NDArray[Any]]) -> NDArray[Any]:
    """
...
def partial_trace(dm : NDArray[Any], part : str, dims_first : int, dims_second : int) -> NDArray[Any] | bool:
    """
...
def partial_transpose(dm : NDArray[Any], part : str, dims_first : int, dims_second : int) -> NDArray[Any] | bool:
    """
...
def trace_norm(operator : NDArray[Any]) -> np.float64 | np.complex128:
    """
...
@overload
def truncate_mantissa(operator : NDArray[np.complex128], decimals : int) -> NDArray[np.complex128]: ...
@overload
def truncate_mantissa(operator : NDArray[np.float64], decimals : int) -> NDArray[np.float64]: ...

def truncate_mantissa(operator, decimals : int):
    """
...
def negativity(operator : NDArray[Any]) -> np.float64:
    """
...
def logarithmic_negativity(operator : NDArray[Any]) -> np.float64:
    """
...
def assess_dm_entanglement(dm : NDArray[Any], part : str, dims_first : int, dims_second : int, rounding : int = None) -> np.float64:
    """
...
def get_entanglement_values(dms : NDArray[Any] | list[Any], part : str, dims_first : int, dims_second : int, rounding : int = None) -> NDArray[np.int_]:
    """
...
def expectation_value(dm : NDArray[Any], operator : NDArray[Any]) -> np.float64 | np.complex128:
    """
...
def data_standardize(data : NDArray[Any]) -> NDArray[Any]:
    """
...
def init_identity(size : int) -> NDArray[np.int_]:
    """
...
def init_destroy(size : int) -> NDArray[np.int_]:
    """
...
def init_create(size : int) -> NDArray[np.int_]:
    """
...
def init_dissipator(dm : NDArray[Any], operator1 : NDArray[Any], operator2 : NDArray[Any] = None) -> NDArray[Any]:
    """
...
def init_dissipators(dm : NDArray[Any], operators : NDArray[Any] | list[Any]) -> NDArray[Any]:
    """
...
def init_multipartite_dc_operators(doperators : NDArray[Any] | list[Any], sizes : NDArray[Any] | list[Any]) -> tuple[list[Any],list[Any]]:
    """
...
def init_sq(alpha : np.complex128 | np.float64, truncate : int) -> NDArray[Any]:
    """
...
def init_two_mode_sq(alpha : np.complex128 | np.float64, a1 : NDArray[np.int_], a2 : NDArray[np.int_]) -> NDArray[Any]:
    """
...
def init_th(mean_n : np.float64, truncate : int, small_trunc_norm : bool = False) -> NDArray[np.int_]:
    """
...
def init_two_mode_th(mean_n : np.float64, truncate : int) -> NDArray[np.int_]:
    """
    ...
    return tensor([init_th(mean_n, truncate, True), init_th(mean_n, truncate, True)])

def init_vac(truncate : int) -> NDArray[np.int_]:
    """
...
def init_ST(alpha : np.complex128 | np.float64, mean_n : np.float64, truncate : int, a1 : NDArray[np.int_], a2 : NDArray[np.int_], rounding : int = None) -> NDArray[Any]:
    """
...
def init_PASV(alpha : np.complex128 | np.float64, truncate : np.float64, a1 : NDArray[np.int_], a2 : NDArray[np.int_], rounding : int = None) -> NDArray[Any]:
    """
...
def init_PASV_sep(alpha1 : np.complex128 | np.float64, alpha2 : np.complex128 | np.float64, truncate : np.float64, a : NDArray[np.int_], rounding : int = None) -> NDArray[Any]:
    """
...
def init_PSSV(alpha : np.complex128 | np.float64, truncate : np.float64, a1 : NDArray[np.int_], a2 : NDArray[np.int_], rounding : int = None) -> NDArray[Any]:
    """
...
def init_PSSV_sep(alpha1 : np.complex128 | np.float64, alpha2 : np.complex128 | np.float64, truncate : np.float64, a : NDArray[np.int_], rounding : int = None) -> NDArray[Any]:
    """
...
def init_NUM(c0 : np.complex128 | np.float64, c1 : np.complex128 | np.float64, truncate : int, rounding : int = None) -> NDArray[Any]:
    """
...
def init_NUM_sep(truncate : int, rounding : int = None) -> NDArray[Any]:
    """
...
def gen_input_states(type : str, amount_of_states : int, truncate : int, entanglement : bool = False, rounding : int = None) -> NDArray[Any] | tuple[NDArray[Any], NDArray[np.int_]]:
    """
...
def unpack_config(filepath : str) -> tuple[np.float64, int, int, str, int, int, int, int]:
    """
...
def system_name(gamma : np.float64, res_size : int, fock_trunc : int, res_connect : str, cm : bool = False) -> str:
    """
...
def gen_system_filepath(folder : str, systemnumber : int | str) -> str:
    """
...
def gen_result_filepath(filename : str) -> str:
    """
