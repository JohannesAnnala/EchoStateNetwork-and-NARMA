...
class QReservoir:
    ...
    def __init__(self, gamma : np.float64 = 1, reservoir_size : int = 4, energy_truncate_level : int = 5, reservoir_connectivity : str = "alltoall", sim_precision : int = 12):
    ...
    def change_reservoir_constants(self, gamma : np.float64 = None, truncate : int = None, reservoir_size : int = None, reservoir_connectivity : str = None) -> None:
        """
    ...
    def init_reservoir(self, initial_state : str) -> None:
        """
    ...
    def init_unitary_evolution(self) -> None:
    ...
    def rk4_timesteps(self, rounds : int) -> None:
        """
    ...
    def inject_input(self, input : NDArray[Any]) -> None:
        """
    ...
    def update_reservoir(self) -> None:
        """
    ...
    def measure_reservoir(self) -> list[Any]:
        """
        Measures the reservoir average occupation numbers.

        Returns
        -------
        A list of reservoir average occupation numbers
        """

        return [expectation_value(self.rho_full, self.b_dag_b[i]).real for i in range(self.reservoir_size)]
        
    def update_and_measure_reservoir(self, inputs : NDArray[Any] | list[NDArray[Any]]) -> NDArray[Any]:
        """
        Simulates the reservoir for a set on inputs interactions and measures
    ...
    def assign_entanglement_from_probabilities(self, Y_pred_prob : NDArray[np.floating]) -> NDArray[np.int_]:
        """
    ...
    def analyze_performance(self, Y_true : NDArray[np.int_], Y_pred : NDArray[np.int_]) -> tuple[np.float64, list[int]]:
        """
    ...
    def train_reservoir(self, inputs : NDArray[Any] | list[NDArray[Any]], entanglement_values : NDArray[np.int_]) -> None:
        """
    ...
    def test_reservoir(self, inputs : NDArray[Any] | list[NDArray[Any]], entanglement_values : NDArray[np.int_]) -> tuple[np.float64, list[int]]:
        """
    ...
    def system_save(self, filepath : str) -> None:
        """
    ...
    def system_load(self, filepath : str) -> None:
        """
